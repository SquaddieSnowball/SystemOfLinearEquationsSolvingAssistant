...
internal sealed class HttpServerManagerService : IHttpServerManagerService
{
    ...
    public HttpServerManagerService(HttpServer httpServer, IHtmlViewLinker htmlViewLinker)
    {
