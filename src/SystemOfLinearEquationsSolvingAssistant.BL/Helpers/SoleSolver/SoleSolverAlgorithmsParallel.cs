...
using SystemOfLinearEquationsSolvingAssistant.BL.Extensions;
...
/// <summary>
/// Provides methods used for parallel solving of the systems of linear equations.
/// </summary>
internal static class SoleSolverAlgorithmsParallel
{
    /// <summary>
